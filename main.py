...
# Set the file as read-write for admin only
os.chmod('passwords.db', 0o600)  # User-only access
...
def add_password_page():
    ...
    # Canvas and Image
    images['lock_img'] = PhotoImage(file="lock.png")
...
# Closing the database connection when the program exits
conn.close()
